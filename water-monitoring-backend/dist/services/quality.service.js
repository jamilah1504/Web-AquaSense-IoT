...
exports.analyzeQuality = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const analyzeQuality = async (readings) => {
    ...
    const evaluateParameter = (parameter, value) => {
        ...
        if (!threshold)
            return 'NORMAL'; // Jika belum diatur, anggap normal
        ...
        if ((threshold.warningMax !== null && value >= threshold.warningMax) ||
